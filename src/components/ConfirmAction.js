...
const ConfirmAction = ({ onClickDelete, onClickCancel }) => {
  return (
    <div class="relative px-4 min-h-full md:flex md:items-center md:justify-center">
      ...
      <div class="bg-black text-white mt-4 rounded-lg md:max-w-md md:mx-auto p-4 fixed inset-x-0 bottom-0 z-50 mb-4 mx-4 md:relative">
        <div class="md:flex items-center">
          <div class="mt-4 md:mt-0 md:ml-6 text-center md:text-left">
            <p class="font-bold">Confimation: Delete</p>
            <p class="text-sm text-gray-700 mt-1 text-white">
